...
include('config.php');
    ...
    if(isset($_POST['Esend'])){
      ...
      $fullname = $firstname." ".$middlename." ".$lastname;
                ...
                $s= mysqli_query($conn,"SELECT * FROM uccp_eval WHERE name ='$fullname' AND remarks ='FAILED' OR remarks ='DROP' ");
                $count = mysqli_num_rows($s);
                
                if($count >0){
                     echo '<script>alert("YOU CANT ENROLL YOU HAVE FAILED MARKS")</script>';
...
//////////////////////////////
                  ...
                  if($totalFileSize  || $totalFileSizePS || $totalFileSizeD || $totalFileSizeG ||$totalFileSizeC || $totalFileSizePR > 0){
                        if($totalFileSize > 5120000){
                          echo '<script type="text/javascript">window.location="freshmenenrollmentform.php";alert("File size too big")</script>';
                          return;
                      }
              ...
              if($totalFileSizePR > 5120000){
                ...
                return;
                    ...
                    if($filetype != "jpg" && $filetype != "png" && $filetype != "jpeg" && $filetype != "gif" ) {
                        echo '<script type="text/javascript">window.location="freshmenenrollmentform.php"; alert("Wrong Input")</script>';
                        return;
                      }
                                                        ...
                                                        if(!empty($proof)){
                                                            ...
                                                            //  sleep(1);
                                                              ...
                                                              move_uploaded_file($_FILES['Proof']['tmp_name'][$key], $targetFilepath);
                                                                ...
                                                                echo '<script type="text/javascript">window.location="freshmenenrollmentform.php";alert("Submit")</script>';
                                                              }
                                                            //////////////////////////////
