     ...
     if( cys, subcode, subname, day, starttime ,endtime,professor,room== ""){
       ...
       $.ajax({
           ...
           success:function(data,status){
             ...
             $('#cyss').load('schedDropdown.php');
             $('#masterlist-section').load('masterlistDropdown.php');
...
$.post("update-sched.php",{update:update},function(data,
 status){
