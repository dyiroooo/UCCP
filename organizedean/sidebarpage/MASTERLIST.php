...
$(document).ready(function(){
  ...
  var masterlist=    $('#masterlist').DataTable({
    ...
    'ajax':{
      ...
      'url': 'sidebarpage/masterlist-tbl.php',
      'type':'post',
...
$.post("sidebarpage/updateremarks.php",{update:update},function(data,
  status){
 ...
 $('#setremarks').modal("show");
   ...
   function setremarks(){
     ...
     $.post("sidebarpage/updateremarks.php", {
     ...
     alert(x);
       ...
       $.ajax({
           ...
           success: function(result) {
             ...
             $('#masterlist-section').load('sidebarpage/masterlistDropdown.php');
              var updates=  $('#masterlist').DataTable().ajax.reload();
