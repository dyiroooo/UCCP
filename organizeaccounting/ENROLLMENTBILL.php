...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#inputbtnenroll', function() {
      ...
      $.ajax({
        url: "inputenrollprice.php",
        type: "post",
        data: {
          id: id,
          orenumber_id: orenumber_id,
          feetypes: feetypes,
          price: price,
  ...
  $(document).on('click', '.acceptenrollee', function() {
    ...
    $.ajax({
      url: "acceptenrolldisp.php",
      type: "post",
      data: {
        acceptenroll_id: acceptenroll_id
      },
      success: function(data) {
    ...
    $(document).on('click', '#acceptenrolleee', function() {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#enrollpaidtbl').load('LISTPAIDENROLLEE.php');
          $("#accepten").modal("hide");
        }
      });
    });
