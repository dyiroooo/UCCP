...
<script>
    ...
    $(document).on('click', '#updatebtn', function() {
      $.ajax({
        ...
        success: function(data) {
          ...
          var b = $('#tblCoursePrice').DataTable().ajax.reload();
        }
      });
    });
  });
  ...
  $(document).on('click', '.deletedata', function() {
    ...
    $.ajax({
      ...
      type: "post",
      data: {
        deletedetails_id: deletedetails_id
      },
      success: function(data) {
    ...
    $(document).on('click', '#deletedetail', function() {
      $.ajax({
        ...
        success: function(data) {
          ...
          var c = $('#tblCoursePrice').DataTable().ajax.reload();
        }
      });
    });
  });
